...
namespace SupermarketTuto
{
    public partial class SellingForm : Form
    {
        ...
        SqlConnection Con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\ASUS\Documents\supermarket.mdf;Integrated Security=True;Connect Timeout=30");
        ...
        {
            e.Graphics.DrawString("SUPERMARKETPBKK", new Font("Century Gothic", 25, FontStyle.Bold), Brushes.Red, new Point(230));
            ...
            e.Graphics.DrawString("PBKK", new Font("Century Gothic", 20, FontStyle.Italic), Brushes.Red, new Point(270,230));
        }
